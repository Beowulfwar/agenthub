...
import { RefreshCw, Zap, Code, LayoutList, FolderPlus } from 'lucide-react';
    ...
    return (
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 py-16">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-700">No workspace loaded</h3>
          <p className="mt-1 text-sm text-gray-500">
            Register an existing workspace or create a new one to manage your skills.
          </p>
          {data?.error && (
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          {data.filePath && (
            <p className="mt-0.5 truncate font-mono text-xs text-gray-400">{data.filePath}</p>
          )}
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white">
          <div className="border-b border-gray-200 px-5 py-3">
            <h3 className="text-sm font-semibold text-gray-700">
              Resolved Skills ({data.resolved.length})
            </h3>
          </div>
